...
export default function Products(){
  return(
    ...
    <div>
      ...
      <div className="w-full max-w-[1240px] mx-auto  mt-10">
        ...
        <div className="flex flex-row gap-[40px]">
          ...
          <div className="space-y-8 mt-3">
            ...
            <div className="flex flex-row gap-[10px]">
              <Image src={box_3} alt="box-03" className="w-[170px] h-[52px]"/>
        ...
        <div className="flex justify-around gap-[650px] mt-[20px]   ">
          <div className="flex flex-row gap-[8px] items-center">
            <h1 className="text-[20px] text-black"><b>All Reviews</b></h1>
            <p className="text-gray-400">(451)</p>
          </div>
          <div className="flex flex-row gap-[10px] ">
            <button className="bg-gray-300 rounded-full p-[15px]"><BsSliders2Vertical /></button>
            <button className=" flex flex-row items-center gap-[4px] pt-[10px] pl-[20px] pb-[10px] pr-[20px] bg-gray-300 rounded-full">
              <p>Latest</p>
              <p><RiArrowDropDownLine size={30}/></p>
            </button>
            <button className="pt-[5px] pl-[35px] pb-[5px] pr-[35px] bg-black text-white rounded-full">Write a Review</button>
          </div>
        </div>
      </div>
      ...
      {/* Section Two */}
      <div className="grid grid-cols-2 just gap-[20px] w-screen mt-[24px] max-w-[1240px] mx-auto ">
      
          {/*Box 01 */}
          <div className="flex flex-col w-[610px] h-[241.58px] border-[1px]  border-gray-200 rounded-3xl">
            ...
            <div className="space-y-4 mt-[20px] ml-[30px]">
              ...
              <div className="flex flex-row gap-1">
                <h1 className="font-bold"><b>Samantha D.</b></h1>
                <div className="bg-green-600 w-[20px] h-[20px] rounded-full"><span><TiTick size={20} color="white"/></span></div>
              </div>

              <p className="text-gray-400">I absolutely love this t-shirt! The design is unique and the fabric feels so <br />
              comfortable. As a fellow designer, I appreciate the attention to detail. It is <br /> 
              become my favorite go-to shirt.</p>
          ...
          <div className="flex flex-col w-[610px] h-[241.58px] border-[1px]  border-gray-200 rounded-3xl">
            ...
            <div className="space-y-4 mt-[20px] ml-[30px]">
              ...
              <div className="flex flex-row gap-1">
                <h1 className="font-bold"><b>Ethan R.</b></h1>
                <div className="bg-green-600 w-[20px] h-[20px] rounded-full"><span><TiTick size={20} color="white"/></span></div>
              </div>

              <p className="text-gray-400">This t-shirt is a must-have for anyone who appreciates good design. The <br />
                 minimalistic yet stylish pattern caught my eye, and the fit is perfect. I can <br />
                 see the designer,s touch in every aspect of this shirt.</p>
      ...
      <div className="flex justify-center mt-[37px] ">
       <button className="border-[1px] text-slate-500 border-gray-200 rounded-full w-[230px] h-[52px]">Load More Reviews</button>
      </div>

      {/* Section Three*/}
      <div className=" w-screen max-w-[1240px] mx-auto mt-[30px]">
        <h1 className="flex justify-center text-[40px] font-bold"><b>YOU MIGHT ALSO LIKE</b></h1>

        <div className="flex flex-row gap-[20px] mt-[20px]">
          <Image src={pic_1} alt="pic-01" width={1000} height={1000} className="w-[295px] h-[298px]"/>
          <Image src={pic_2} alt="pic-02" width={1000} height={1000} className="w-[295px] h-[298px]"/>
          <Image src={pic_3} alt="pic-03" width={1000} height={1000} className="w-[295px] h-[298px]"/>
          <Image src={pic_4} alt="pic-04" width={1000} height={1000} className="w-[295px] h-[298px]"/>
        </div>
      </div>
    </div>
  )
